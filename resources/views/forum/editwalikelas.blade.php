...
<main-layout>
    <title>Edit Data Walikelas | E-Learning</title>
    <x-sidebar>
        <x-validation-errors class="mb-4 bg-skyblue-300 px-3 py-2" />
        <form action="{{ route('update-walkel', $walkel->slug) }}" method="post" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            ...
            <div class="">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <select id="underline_select" name="nuptk" id="nuptk"
                        ...
                        required>
                        <option value="{{ $walkel->nuptk }}">{{ $walkel->nuptk }} (sekarang)</option>
            ...
            <div class="">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <select id="underline_select" name="kelas" id="kelas"
                        class="block py-2.5 px-1 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        required>
                        <option value="{{ $walkel->kelas }}">{{ $walkel->kelas }} (sekarang)</option>
            ...
            <div class="">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <select id="underline_select" name="jurusan" id="jurusan"
                        class="block py-2.5 px-1 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        required>
                        <option value="{{ $walkel->jurusan }}">{{ $walkel->jurusan }} (sekarang)</option>
