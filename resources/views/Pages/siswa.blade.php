    ...
    <x-sidebar>
        <div>
            ...
            <div class="flex flex-wrap justify-between items-center mb-4 gap-2">
                ...
                <div>
                    <form method="GET" action="{{ route('data-siswa') }}" class="mb-4" autocomplete="off">
                        ...
                        @if ($data->gender == 'Laki-Laki')
                            <tr class="border-b hover:font-bold bg-gray-200">
                                ...
                                <td class="md:justify-center py-2 md:flex">
                                    {{-- view --}}
                                    <button>
                                        <a href="{{ route('show-siswa', $data->slug) }}" target="">
                                            <img src="{{ asset('Image/Icon/eye.png') }}"
                                                class="w-5 md:w-7 mx-1 grayscale hover:grayscale-0" alt="view-icon">
                                        </a>
                                    </button>
                                    ...
                                    @if (Auth::user()->roles == 'admin')
                                        {{-- edit --}}
                                        <button>
                                            <a href="{{ route('edit-siswa', $data->slug) }}">
                                        ...
                                        {{-- delete --}}
                                        <form action="{{ route('delete-siswa', $data->slug) }}" method="POST">
                                            @csrf
                                            <button>
